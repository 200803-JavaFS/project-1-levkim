...
public class Application {
	...
	public static void insert() {
		...
		LocalDateTime tr = LocalDateTime.MIN;
		
		LocalDateTime t1 = LocalDateTime.now();
		Reimb r1 = new Reimb(20.00, t1, tr, u1, null, rdao.findStatusId(1), rdao.findTypeId(2));
		
		LocalDateTime t2 = LocalDateTime.now();
		Reimb r2 = new Reimb(50.00, t2, tr, u2, null, rdao.findStatusId(3), rdao.findTypeId(4));
		
		LocalDateTime t3 = LocalDateTime.now();
		Reimb r3 = new Reimb(50.00, t3, tr, u3, null, rdao.findStatusId(2), rdao.findTypeId(1));
		
		LocalDateTime t4 = LocalDateTime.now();
		Reimb r4 = new Reimb(50.00, t4, tr, u3, null, rdao.findStatusId(1), rdao.findTypeId(3));
